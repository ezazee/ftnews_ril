/*! UniCore 3.19.1 | https://www.unistudio.co | (c) 2023 - 2024 UniStudio | MIT License */ !(function (
    t,
    e
) {
    "object" == typeof exports && typeof module < "u"
        ...
        : ((t = typeof globalThis < "u" ? globalThis : t || self).UniCore = e(
              t.anime
          ));
})(this, function (t) {
    "use strict";
    ...
    const s = /\B([A-Z])/g,
        ...
        r = /-(\w)/g,
        a = K((t) =>
            (t.charAt(0).toLowerCase() + t.slice(1)).replace(r, (t, e) =>
                e.toUpperCase()
            )
        ),
    ...
    function h(t, e) {
        var i;
        return null == (i = null == t ? void 0 : t.startsWith)
            ? void 0
            : i.call(t, e);
    }
    function c(t, e) {
        var i;
        return null == (i = null == t ? void 0 : t.endsWith)
            ? void 0
            : i.call(t, e);
    }
    function d(t, e) {
        var i;
        return null == (i = null == t ? void 0 : t.includes)
            ? void 0
            : i.call(t, e);
    }
    function u(t, e) {
        var i;
        return null == (i = null == t ? void 0 : t.findIndex)
            ? void 0
            : i.call(t, e);
    }
    ...
    function z(t, e, i) {
        return t.replace(new RegExp(`${e}|${i}`, "g"), (t) =>
            t === e ? i : e
        );
    }
    function H(t) {
    ...
    function U(...t) {
        return [
            ...
            ([e, i]) =>
                Math.min(...t.map(({ [e]: t }) => t)) -
                    Math.max(...t.map(({ [i]: t }) => t)) >
                0
        );
    }
    function Y(t, e) {
    ...
    function Q(t, e, i) {
        ...
        if (v(e)) for (const i in e) Q(t, i, e[i]);
            ...
            for (const n of B(t))
                g(i) && (i = i.call(n, Q(n, e))),
                    null === i ? et(n, e) : n.setAttribute(e, i);
        }
    }
    function tt(t, e) {
    ...
    function ot(t, e) {
        e = new RegExp(e);
        for (const i of B(t))
            i.classList.remove(...p(i.classList).filter((t) => t.match(e)));
    }
    function rt(t, e, i) {
    ...
    function kt(t) {
        return (
            (t = _(t)) &&
            ["origin", "pathname", "search"].every((e) => t[e] === location[e])
        );
    }
    function Ct(t) {
        if (kt(t)) {
    ...
    function Zt(t) {
        ...
        const { clientX: n, clientY: s } =
            (null == (e = t.touches) ? void 0 : e[0]) ||
            (null == (i = t.changedTouches) ? void 0 : i[0]) ||
            t;
        return { x: n, y: s };
    }
    const Kt = {
                            ...
                            (t) =>
                                new Promise((s, o) => {
                                    ...
                                    qt(
                                        ...
                                        nt(t, ee),
                                        Qt(t, {
                                            transitionProperty: Object.keys(e)
                                                .map(te)
                                                .join(","),
    ...
    function de(t, ...e) {
        return e.some((e) => {
            var i;
            return (
                (null == (i = null == t ? void 0 : t.tagName)
                    ? void 0
    ...
    function $e(t, e) {
        return B(
            B(t).map((t) =>
                t.hasChildNodes() ? xe(p(t.childNodes), e) : me(t, e)
            )
        );
    }
    function ye(t) {
    ...
    function Pe(t) {
        const e = y(t)
            ...
            : { height: Oe(t), width: Ne(t), top: 0, left: 0 };
        return {
            height: e.height,
            width: e.width,
            top: e.top,
    ...
    function _e(t) {
        ...
        let r = o || s;
        for (; r && (r === n || r === s) && "static" === Qt(r, "position"); )
            r = r.parentNode;
        if (y(r)) {
            const t = Me(r);
            (e -= t.top + M(Qt(r, "borderTopWidth"))),
                (i -= t.left + M(Qt(r, "borderLeftWidth")));
        }
        return {
    ...
    function He(t, e, i = "border-box") {
        return Qt(t, "boxSizing") === i
            ? L(
                  De[e].map(l),
                  (e) => M(Qt(t, `padding${e}`)) + M(Qt(t, `border${e}Width`))
              )
            : 0;
    }
    function Fe(t) {
        for (const e in De)
            for (const i in De[e]) if (De[e][i] === t) return De[e][1 - i];
        return t;
    }
    ...
    function si(t) {
        ai(ni.reads),
            ai(ni.writes.splice(0)),
            (ni.scheduled = !1),
            (ni.reads.length || ni.writes.length) && ri(t + 1);
    }
    const oi = 4;
    function ri(t) {
        ni.scheduled ||
            ((ni.scheduled = !0),
            t && t < oi
                ? Promise.resolve().then(() => si(t))
                : requestAnimationFrame(() => si(1)));
    }
    function ai(t) {
        let e;
        for (; (e = t.shift()); )
    ...
    class hi {
        ...
        cancel() {
            var t;
            null == (t = this.unbind) || t.call(this),
    ...
    function ui(t, e, i = { box: "border-box" }) {
        ...
        const n = [
            Lt(window, "load resize", e),
            Lt(document, "loadedmetadata load", e, !0),
        ];
    ...
    function gi(t) {
        $i(t) && Ii(t, { func: "playVideo", method: "play" }),
            xi(t) && t.play();
    }
    function vi(t) {
        $i(t) && Ii(t, { func: "pauseVideo", method: "pause" }),
            xi(t) && t.pause();
    }
    function wi(t) {
        $i(t) && Ii(t, { func: "mute", method: "setVolume", value: 0 }),
            xi(t) && (t.muted = !0);
    }
    function bi(t) {
        return xi(t) || $i(t);
                        ...
                        try {
                            return (
                                ...
                                (e &&
                                    ...
                                    (i &&
                                        Number(
                                            null == t ? void 0 : t.player_id
                                        ) === n)
                            );
                        } catch {}
                    }),
                    (t.src = `${t.src}${d(t.src, "?") ? "&" : "?"}${
                        e ? "enablejsapi=1" : `api=1&player_id=${n}`
                    }`);
    ...
    function _i(t) {
        ...
        for (let [e, s, o, r] of [
            ...
            b(i)
                ? (i = t.ownerDocument)
                : (n[o] += M(Qt(i, `border-${o}-width`)));
            const a = n[e] % 1;
            (n[e] = n[s] =
                i[`client${l(e)}`] - (a ? (a < 0.5 ? -a : 1 - a) : 0)),
                (n[r] = n[e] + n[o]);
        }
        return n;
    }
    ...
    function Vi(t, e, i, n, s) {
        ...
        return (
            i && ((o[Hi[s][2]] += i), (o[Hi[s][3]] -= i)),
            n && (o = Yi(o, Me(f(n) ? n[s] : n))),
            o
        );
    }
    function Ri(t, e, i, n) {
    ...
    function Ji(t, e, { offset: i, attach: n }, s) {
        return Li(t, e, {
            attach: { element: Zi(n.element, s), target: Zi(n.target, s) },
            offset: Qi(i, s),
        });
    }
    function Gi(t, e, i) {
    ...
    var tn = Object.freeze({
            ...
            ready: function (t) {
                "loading" === document.readyState
                    ? qt(document, "DOMContentLoaded", t)
                    : t();
            },
            remove: be,
            removeAttr: et,
        ...
        methods: {
            start() {
                this.stop(),
                    this.update(),
                    this.timer ||
                        (Vt(this.$el, "countdownstart"),
                        (this.timer = setInterval(this.update, 1e3)));
            },
            stop() {
                this.timer &&
                    (clearInterval(this.timer),
                    Vt(this.$el, "countdownstop"),
                    (this.timer = null));
            },
            update() {
                const t = (function (t) {
                ...
                t.total ||
                    (this.stop(),
                    this.end ||
                        (Vt(this.$el, "countdownend"), (this.end = !0)));
                for (const e of nn) {
                    const i = Te(
                        this.clsWrapper.replace("%unit%", e),
                        this.$el
                    );
                    if (!i) continue;
                    ...
                    (n = n.length < 2 ? `0${n}` : n),
                        i.textContent !== n &&
                            ...
                            n.length !== i.children.length &&
                                fe(i, n.map(() => "<span></span>").join("")),
                            n.forEach(
                                (t, e) => (i.children[e].textContent = t)
                            ));
                }
            },
        },
        ...
        return t === Boolean
            ...
            ? (function (t) {
                  return f(t)
                      ? t
                      : k(t)
                      ? t.split(un).map((t) => (T(t) ? P(t) : D(t.trim())))
                      : [t];
              })(e)
            : t === Object && k(e)
            ? cn(e)
    ...
    function bn(t) {
        return $n(
            (t, e) => ({ disconnect: Lt(yn(t), "scroll", e, { passive: !0 }) }),
            t,
            "scroll"
        );
    }
    function xn(t) {
        return {
            observe: (t, e) => ({
                observe: R,
                unobserve: R,
                disconnect: Lt(t, Ze, e, { passive: !0 }),
            }),
            handler(t) {
                if (!Gt(t)) return;
                const e = Zt(t),
    ...
    function kn(t, e = !1) {
        ...
        return (
            e && ([i, n] = Be(t)),
            { top: i, left: n, bottom: i + s, right: n + o }
        );
    }
    ...
    function En(t, e, i, n = 0) {
        const s = An(e, !0),
            ...
            h = a(async () => {
                ...
                a !== h &&
                    d.push(
                        se.start(e, { height: h }, i / 2 + c.length * n, "ease")
                    ),
        ...
        return Promise.all(
            St(t)
                ...
                .map(
                    (t) =>
                        new Promise((e) =>
                            qt(t, "transitionend transitioncanceled", e)
                        )
                )
        );
    }
    ...
    async function Mn(t, e, i) {
        ...
        n.forEach((t, e) => h[e] && Qt(t, h[e])),
            Qt(e, o),
            Vt(e, "scroll"),
            ni.flush(),
            await On();
        const u = n
            .map((t, n) => vt(t) === e && se.start(t, l[n], i, "ease"))
            .concat(se.start(e, a, i, "ease"));
        try {
            await Promise.all(u),
                n.forEach((t, i) => {
                    Q(t, c[i]),
                        vt(t) === e &&
                            Qt(t, "display", 0 === l[i].opacity ? "none" : "");
                }),
                Q(e, "style", r);
        } catch {
            Q(n, "style", ""),
        ...
        methods: {
            ...
            getState() {
                return this.toggles
                    ...
                    .reduce((t, e) => Xn(e, this.attrItem, t), {
                        filter: { "": "" },
                        sort: [],
                    });
            },
            async setState(t, e = !0) {
                ...
                for (const e of this.toggles)
                    lt(e, this.cls, Jn(e, this.attrItem, t));
                await Promise.all(
    ...
    function Kn(t) {
        ...
        return (
            ...
            () => {
                (Zn = !1),
                    e(),
                    Qt(i, { overflowY: "", touchAction: "", paddingRight: "" });
            }
        );
    }
    var Qn = {
            ...
            methods: {
                ...
                isToggled(t = this.$el) {
                    return (
                        ...
                        (!at(t, this.clsLeave) &&
                            (this.cls ? at(t, this.cls.split(" ")[0]) : ut(t)))
                    );
                },
                _toggle(t, e) {
                    if (!t) return;
                    ...
                    (e = !!e),
                        ...
                        Ee("[autofocus]", t).some((t) =>
                            ut(t) ? t.focus() || !0 : t.blur()
                        ),
    ...
    async function is(
        t,
        e,
        { animation: i, duration: n, velocity: s, transition: o, _toggle: r }
    ) {
        var a;
        const [l = "reveal", h = "top"] =
                (null == (a = i[0]) ? void 0 : a.split("-")) || [],
            c = [
                ["left", "right"],
                ["top", "bottom"],
            ],
        ...
        f && (Qt(t, m, S - v + $), (C[m] = e ? $ : S + $)),
            !f ^ ("reveal" === l) &&
                (Qt(I, m, -S + v), se.start(I, { [m]: e ? 0 : -S }, n, o));
        try {
    ...
    function ns(t, e, i) {
        ...
        return e
            ? (o(t, !0), ce.in(t, n[0], s, i.origin))
            : ce.out(t, n[1] || n[0], s, i.origin).then(() => o(t, !1));
    }
    const ss = [];
    var os = {
        mixins: [en, Qn, ts],
        ...
        connected() {
            Q(this.panel || this.$el, "role", this.role),
                this.overlay && Q(this.panel || this.$el, "aria-modal", !0);
        },
        beforeDisconnect() {
        ...
        events: [
            ...
            },
            {
                ...
                handler(t) {
                    t.defaultPrevented ||
                        (t.preventDefault(),
                        this.isToggled() === d(ss, this) && this.toggle());
                },
            },
            {
                name: "beforeshow",
                ...
                handler(t) {
                    ...
                    !this.stack && ss.length
                        ? (Promise.all(ss.map((t) => t.hide())).then(this.show),
                          t.preventDefault())
                        : ss.push(this);
                },
            },
            ...
            },
            {
                ...
                self: !0,
                handler() {
                    gt(this.$el) || Q(this.$el, "tabindex", "-1"),
                        bt(this.$el, ":focus-within") || this.$el.focus();
                },
            },
            {
                name: "hidden",
                ...
                handler() {
                    d(ss, this) && ss.splice(ss.indexOf(this), 1),
                        Qt(this.$el, "zIndex", ""),
                        ss.some((t) => t.clsPage === this.clsPage) ||
                            st(document.documentElement, this.clsPage);
                },
            },
        ],
        methods: {
    ...
    var ms = {
        ...
        gs = {
            ...
            connected() {
                Q(this.list, "aria-live", this.autoplay ? "off" : "polite"),
        ...
        created() {
            for (const t of ["start", "move", "end"]) {
                ...
                this[t] = (t) => {
                    ...
                    (this.prevPos = i === this.pos ? this.prevPos : this.pos),
                        (this.pos = i),
                        e(t);
                };
            }
            ...
            move(t) {
                ...
                for (const t of [this.index, this.prevIndex])
                    d([o, n], t) ||
                        ...
                        c && ((u = !0), (this.prevIndex = n)));
                ((this.index === n && this.prevIndex !== n) || u) &&
                    Vt(i[this.index], "itemshown", [this]),
                    h &&
                        ((this.prevIndex = n),
                        (this.index = o),
                        c ||
                            (Vt(a, "beforeitemhide", [this]),
                            Vt(a, "itemhide", [this])),
                ...
                if (
                    (Wt(document, bs, this.move, vs),
                    Wt(document, xs, this.end, ws),
                    this.dragging)
                )
            ...
            !(!s || (f(s) && !s.length) || (h && !h.call(t))) &&
                t._events.push(
                    Lt(
                        s,
                        n,
                        l ? (k(l) ? l : l.call(t, t)) : null,
                        k(o) ? t[o] : o.bind(t),
                        { passive: a, capture: r, self: c }
                    )
                );
    }
    function Ps(t, ...e) {
    ...
    function Ms(t, e) {
        ...
        g(s) &&
            f(t[h]) &&
            c.unobserve &&
            Is(t, { handler: _s(c), immediate: !1 }, h),
            Ps(t, c);
    }
    function _s(t) {
        return (e, i) => {
    ...
    function Bs(t) {
        ...
        for (const t in n) {
            ...
            let r = it(s, i);
            A(r) ||
                ((r = (n[t] === Boolean && "" === r) || dn(n[t], r)),
                ("target" !== i || !h(r, "_")) && (e[t] = r));
        }
        const l = cn(it(s, r), i);
        for (const t in l) {
            const i = a(t);
        ...
        (e.data = (function (
            ...
            f(t) &&
                (t = t
                    .slice(0, e.length)
                    .reduce(
                        (t, i, n) => (w(i) ? m(t, i) : (t[e[n]] = i), t),
                        {}
                    ));
            for (const e in t)
                A(t[e]) ? delete t[e] : i[e] && (t[e] = dn(i[e], t[e]));
            return t;
    ...
    function Rs(t, e) {
        ...
        return (
            ...
            Ls._initialized &&
                !s.functional &&
                requestAnimationFrame(() => Us(t, `[${n}],[data-${n}]`)),
            (Vs[n] = s)
        );
    }
    function Us(t, e, i, ...n) {
                ...
                navItems(t) {
                    for (const e of t) {
                        ...
                        if (T(t)) {
                            ...
                            this.list &&
                                (this.list.id ||
                                    (this.list.id = Ks(this, this.list)),
                                (s = this.list.id)),
                                (n = this.t(t));
                        Q(i, {
                            "aria-controls": s,
            ...
            events: [
                {
                    ...
                    handler(t) {
                        t.target.closest("a,button") &&
                            ...
                            (t.preventDefault(),
                            this.show(it(t.current, this.attrItem)));
                    },
                },
            ...
            methods: {
                show(t, e = !1) {
                    ...
                    if (
                        ...
                        (this.prevIndex = r),
                        (this.index = l),
                        (a && !Vt(a, "beforeitemhide", [this])) ||
                            !Vt(h, "beforeitemshow", [this, a]))
                    )
        ...
        so = {
            ...
            created() {
                ...
                const i = Te("[uc-close]", t),
                    n = this.t("close");
                i && n && (i.dataset.i18n = JSON.stringify({ label: n })),
            ...
            events: [
                ...
                },
                {
                    ...
                    async handler(t, e) {
                        ...
                        if ((this.setItem(e, "<span uc-spinner></span>"), !i))
                            return;
                        let a;
                        const l = {
                            allowfullscreen: "",
                        ...
                        if (
                            "image" === n ||
                            i.match(
                                /\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i
                            )
                        ) {
                            const t = oo("img", { src: i, alt: s, ...r });
                            Lt(t, "load", () => this.setItem(e, t)),
                                Lt(t, "error", () => this.setError(e));
                        } else if (
                            "video" === n ||
                            i.match(/\.(mp4|webm|ogv)($|\?)/i)
                        ) {
                            const t = oo("video", {
                                src: i,
                                poster: o,
                            ...
                            Lt(t, "loadedmetadata", () => this.setItem(e, t)),
                                Lt(t, "error", () => this.setError(e));
                        } else if (
                            "iframe" === n ||
                            i.match(/\.(html|php)($|\?)/i)
            ...
            methods: {
                loadItem(t = this.index) {
                    ...
                    this.getSlide(e).childElementCount ||
                        Vt(this.$el, "itemload", [e]);
                },
                ...
                setError(t) {
                    this.setItem(
                        t,
                        '<span uc-icon="icon: bolt; ratio: 2"></span>'
                    );
                },
                showControls() {
            ...
            this.$mount(
                me(
                    ...
                    `<div class="${this.clsMsg}${
                        ...
                        this.clsClose
                    }" data-uc-close></a> <div>${this.message}</div> </div>`
                )
            );
        },
        async connected() {
            ...
            if (((this.matchMedia = !0), t || e)) {
                ...
                const n = () => {
                    (this.matchMedia = this.mediaObj.matches),
                        Vt(
                            this.$el,
                            Rt("mediachange", !1, !0, [this.mediaObj])
                        );
                };
    ...
    function bo(t, e, i, n) {
        ...
        if ("cover" === Ao(e, "backgroundSize", ""))
            return (function (t, e, i, n) {
                const s = (function (t) {
                    const e = Qt(t, "backgroundImage").replace(
                        /^none|url\(["']?(.+?)["']?\)$/,
                        "$1"
                    );
                    if (yo[e]) return yo[e];
                ...
                return (t, e) => {
                    h(t, e),
                        (t.backgroundSize = `${l.width}px ${l.height}px`),
    ...
    function $o(t, e, i) {
        return function (n, s) {
            for (const o of t) {
                const t = Co(i[o], s);
                n[
                    `background-position-${o.substr(-1)}`
                ] = `calc(${e[o]} + ${t}px)`;
            }
        };
    }
    ...
    var Mo = {
        ...
        update: {
            read({ percent: t }, e) {
                ...
                return {
                    percent: (t = Po(
                        Ai(this.target, this.start, this.end),
                        this.easing
                    )),
            ...
            write() {
                ...
                const t = this.parallaxTarget,
                    e = Po(
                        Ai(
                            t,
                            je(this.parallaxStart, "height", t, !0),
                            je(this.parallaxEnd, "height", t, !0)
                        ),
                        this.parallaxEasing
                    ),
    ...
    var Oo = {
        ...
        No = {
            ...
            methods: {
                getAdjacentSlides() {
                    return [1, -1].map(
                        (t) => this.slides[this.getIndex(this.index + t)]
                    );
                },
            },
        };
    ...
    function jo(t, e) {
        return (
            (t &&
                (_e(t).left + (Xe ? Pe(t).width - Pe(e).width : 0)) *
                    (Xe ? -1 : 1)) ||
            0
        );
    }
    ...
    var qo = {
                    ...
                    e + s > n && (e = 0),
                        this.center
                            ? e < n / 2 &&
                              e +
                                  s +
                                  Pe(this.slides[Z(+t + 1, this.slides)])
                                      .width /
                                      2 >
                                  n / 2 &&
                              (i.push(+t), (e = n / 2 - s / 2))
        ...
        events: {
            beforeitemshow(t) {
                ...
                (this.duration =
                    eo(n / this.velocity) * (Pe(this.slides[i]).width / n)),
                    this.reorder();
            },
            itemshow() {
                ~this.prevIndex &&
                    nt(this._getTransitioner().getItemIn(), this.clsActive),
        ...
        methods: {
            ...
            updateActiveClasses(t = this.index) {
                ...
                "all" !== this.active &&
                    (e = [this.slides[this.getValidIndex(t)]]);
                const i = [
                    this.clsActive,
                    !this.sets || d(this.sets, M(this.index))
                        ? this.clsActivated
                        : "",
                ];
                for (const t of this.slides) {
                    ...
                    for (const e of Ee(mt, t))
                        n(e, "_tabindex") || (e._tabindex = Q(e, "tabindex")),
                            Q(e, "tabindex", s ? e._tabindex : -1);
                }
            },
            getValidIndex(t = this.index, e = this.prevIndex) {
            ...
            getAdjacentSlides() {
                ...
                for (const t of [-1, 1]) {
                    ...
                    do {
                        const e =
                            this.slides[
                                this.getIndex(this.index + t + a++ * t)
                            ];
            ...
            getIndexAt(t) {
                ...
                let i =
                        ...
                        (this.center
                            ? Fo(this.list) -
                              (Pe(this.slides[0]).width / 2 +
                                  Pe(H(this.slides)).width / 2)
                            : Fo(this.list, this.maxIndex)),
                    n = 0;
                do {
                    const t = Pe(this.slides[++e]).width,
                        s = this.center
                            ? t / 2 + Pe(this.slides[e + 1]).width / 2
                            : t;
                    (n = (i / s) % 1), (i -= s);
        ...
        events: [
            {
                ...
                handler({
                    type: t,
                    detail: { percent: e, duration: i, timing: n, dir: s },
                }) {
                    ni.read(() => {
                        if (!this.matchMedia) return;
                        ...
                        ni.write(() => {
                            Qt(this.$el, o),
                                se.start(this.$el, r, i, n).catch(R);
                        });
                    });
                },
            },
    ...
    var Yo = {
            ...
            fade: {
                ...
                percent: (t) => 1 - Qt(t, "opacity"),
                translate: (t) => [
                    { opacity: 1 - t, zIndex: 0 },
                    { zIndex: -1 },
                ],
            },
            scale: {
                show: () => [
                    { opacity: 0, transform: fs(1.5), zIndex: 0 },
                    { zIndex: -1 },
                ],
                percent: (t) => 1 - Qt(t, "opacity"),
                translate: (t) => [
                    { opacity: 1 - t, transform: fs(1 + 0.5 * t), zIndex: 0 },
                    { zIndex: -1 },
                ],
            },
            pull: {
        ...
        Jo = {
            ...
            watch: {
                ...
                handles(t, e) {
                    Qt(e, { touchAction: "", userSelect: "" }),
                        Qt(t, { touchAction: "none", userSelect: "none" });
                },
            },
            update: {
                write(t) {
            ...
            methods: {
                ...
                move(t) {
                    ...
                    if (
                        (Wt(document, Ke, this.move),
                        Wt(document, Qe, this.end),
                        !this.drag)
                    )
                        return;
                    clearInterval(Go);
                    ...
                    this === t
                        ? this.origin.index !== It(this.placeholder) &&
                          Vt(this.$el, "moved", [this, this.placeholder])
                        : (Vt(t.$el, "added", [t, this.placeholder]),
                          Vt(this.$el, "removed", [this, this.placeholder])),
                        Vt(this.$el, "stop", [this, this.placeholder]),
                        be(this.drag),
                        (this.drag = null);
                    for (const { clsPlaceholder: t, clsItem: e } of this
                        .touched)
                        for (const i of this.touched) st(i.items, t, e);
                    (this.touched = null),
                        st(document.documentElement, this.clsDragState);
                },
                insert(t, e) {
                    nt(this.items, this.clsItem);
                ...
                getSortable(t) {
                    do {
                        ...
                        if (
                            e &&
                            (e === this ||
                                (!1 !== this.group && e.group === this.group))
                        )
                            return e;
                    } while ((t = vt(t)));
                },
        ...
        methods: {
            positionAt(t, e, i) {
                ...
                const s = [this.flip && "flip", this.shift && "shift"],
                    o = {
                        element: [
                            this.inset ? this.dir : Fe(this.dir),
                            this.align,
                        ],
            ...
            getShiftOffset(t = this.$el) {
                return "center" === this.align
                    ? 0
                    : je(
                          Qt(t, "--uc-position-shift-offset"),
                          "y" === this.axis ? "width" : "height",
                          t
                      ) * (d(["left", "top"], this.align) ? 1 : -1);
            },
            getViewportOffset: (t) =>
                je(Qt(t, "--uc-position-viewport-offset")),
        },
    };
    var Qo = {
        mixins: [Qn, ts, Ko],
                ...
                (this.tooltip = me(
                    ...
                    Lt(this.tooltip, "toggled", (t, e) => {
                        ...
                        const o = [
                            ...
                            Lt([document, ...Mi(this.$el)], "scroll", i, {
                                passive: !0,
                            }),
                        ];
    ...
    var tr = {
        ...
        events: {
            ...
            drop(t) {
                ...
                null != e &&
                    e.files &&
                    (st(this.$el, this.clsDragover), this.upload(e.files));
            },
            dragenter(t) {
                ir(t);
            },
                ...
                for (const e of t) {
                    if (this.maxSize && 1e3 * this.maxSize < e.size)
                        return void this.fail(
                            this.t("invalidSize", this.maxSize)
                        );
                    if (this.allow && !er(this.allow, e.name))
                        return void this.fail(
                            this.t("invalidName", this.allow)
                        );
                    if (this.mime && !er(this.mime, e.type))
                        return void this.fail(this.t("invalidMime", this.mime));
                }
        ...
        sr = {
            connected() {
                ...
                this.registerObserver(
                    ui(
                        (null == (t = this.$options.resizeTargets)
                            ? void 0
                            : t.call(this)) || this.$el,
                        () => this.$emit("resize")
                    )
    ...
    function ar(t) {
        Vt(document, "uikit:init", t),
            ...
            new MutationObserver((t) => t.forEach(lr)).observe(document, {
                subtree: !0,
                childList: !0,
            }),
    ...
    (function (t) {
        ...
        (t.component = Rs),
            ...
            (t.mixin = function (t, e) {
                (e = (k(e) ? this.component(e) : e) || this).options = hn(
                    e.options,
                    t
                );
            }),
            (t.extend = function (t) {
                ...
                return (
                    ((i.prototype = Object.create(e.prototype)).constructor =
                        i),
        ...
        (nr.prototype.$destroy = function (t = !1) {
            ...
            i && Hs(e),
                ...
                (function (t, e) {
                    var i;
                    null == (i = t[qs]) || delete i[e.$options.name],
                        E(t[qs]) || delete t[qs];
                })(i, e),
                t && be(e.$el);
        }),
            ...
            update: {
                read() {
                    ...
                    if (!n || !s) {
                        const e = {
                            width:
                                i.naturalWidth || i.videoWidth || i.clientWidth,
                            height:
                                i.naturalHeight ||
                                i.videoHeight ||
                                i.clientHeight,
    ...
    var yr = {
        ...
        disconnected() {
            this.isActive() && (this.hide(!1), ($r = null)),
                Qt(this.$el, this._style);
        },
        observe: vn({
            target: ({ toggle: t, $el: e }) => Tt(t, e),
            targets: ({ $el: t }) => t,
        }),
        events: [
            {
            ...
            },
            {
                ...
                handler(t, e) {
                    t.preventDefault(),
                        this.isToggled()
                            ? this.hide(!1)
                            : this.show(null == e ? void 0 : e.$el, !1);
                },
            },
            {
                name: "toggleshow",
            ...
            },
            {
                ...
                handler(t) {
                    t.preventDefault(),
                        bt(this.$el, ":focus,:hover") || this.hide();
                },
            },
            {
                name: `${ti} focusin`,
            ...
            },
            {
                ...
                handler() {
                    ($r = this),
                        this.tracker.init(),
                        Q(this.targetEl, "aria-expanded", !0);
                    const t = [
                        Sr(this),
                        kr(this),
                        Tr(this),
                    ...
                    qt(this.$el, "hide", () => t.forEach((t) => t && t()), {
                        ...
                        this.bgScroll ||
                            qt(this.$el, "hidden", Kn(this.$el), { self: !0 });
                },
            },
        ...
        methods: {
                    ...
                    if ($r) {
                        if (e && $r.isDelaying)
                            return void (this.showTimer = setTimeout(
                                () => bt(t, ":hover") && this.show(),
                                10
                            ));
                        let i;
                        for (; $r && i !== $r && !$r.$el.contains(this.$el); )
                            (i = $r), $r.hide(!1, !1);
                    }
                    this.container &&
                        vt(this.$el) !== this.container &&
                        me(this.container, this.$el),
            ...
            hide(t = !0, e = !0) {
                const i = () =>
                    this.toggleElement(this.$el, !1, this.animateOut && e);
                this.clearTimers(),
                        ...
                        Qt(this.$el, {
                            [o]:
                                (l[r] > h[r]
                                    ? l[this.inset ? a : r] -
                                      Math.max(
                                          Me(this.boundary[n])[r],
                                          t[n][r] + e
                                      )
                                    : Math.min(
                                          Me(this.boundary[n])[a],
                                          t[n][a] - e
                                      ) - l[this.inset ? r : a]) - i,
                            [`overflow-${s}`]: "auto",
                        }),
    ...
    var Er = {
        ...
        events: [
            ...
            },
            {
                ...
                handler() {
                    ...
                    t &&
                        d(t.mode, "hover") &&
                        !this.dropdowns.some((t) => bt(t, ":hover")) &&
                        t.hide();
                },
            },
            {
                ...
                handler({ target: t }) {
                    this.isDropbarDrop(t) &&
                        (this.dropbar.previousElementSibling !==
                            this.dropbarAnchor &&
        ...
        methods: {
            getActive() {
                var t;
                return (
                    d(this.dropdowns, null == (t = $r) ? void 0 : t.$el) && $r
                );
            },
            ...
            initializeDropdowns() {
                this.$create(
                    ...
                    this.dropdowns.filter((t) => !this.getDropdown(t)),
                    {
                        ...
                        boundary:
                            !0 === this.boundary ? this.$el : this.boundary,
                    }
                );
            },
        },
    ...
    function Ar(t, e, i) {
        ...
        a === Ln
            ...
            ? (l = "next")
            : a === zn &&
              (null == (n = i.targetEl) || n.focus(),
              null == (s = i.hide) || s.call(i, !1)),
            ~l &&
                (t.preventDefault(),
                ...
                const s = pt(e) ? "value" : "textContent",
                    ...
                    r =
                        null != (t = i.files) && t[0]
                            ? i.files[0].name
                            : bt(i, "select") &&
                              (n = Ee("option", i).filter((t) => t.selected)[0])
                            ? n.textContent
                            : i.value;
                o !== r && (e[s] = r);
            },
            ...
            update: [
                ...
                },
                {
                    read(t) {
                        ...
                        const h = r.map(
                                (t) => L(t, "offsetHeight") + l * (t.length - 1)
                            ),
                            c = Math.max(0, ...h);
                        let d, u, f;
                        return (
                    ...
                    write({ height: t, padding: e }) {
                        Qt(this.$el, "paddingBottom", e || ""),
                            !1 !== t && Qt(this.$el, "height", t);
                    },
                    events: ["resize"],
                },
                {
    ...
    var Br = {
        ...
        update: {
            read() {
                return {
                    rows: (this.row ? In(this.elements) : [this.elements]).map(
                        Or
                    ),
                };
            },
            write({ rows: t }) {
                for (const { heights: e, elements: i } of t)
                    i.forEach((t, i) => Qt(t, "minHeight", e[i]));
            },
            events: ["resize"],
        },
    };
            ...
            update: {
                read() {
                    ...
                    const e = He(this.$el, "height", "content-box"),
                        ...
                        r = n === s || i === s;
                    if (
                        ((t = "calc(" + (r ? "100vh" : `${o}px`)), this.expand)
                    ) {
                        ...
                        !0 === this.offsetBottom
                            ? (t += ` - ${
                                  Pe(this.$el.nextElementSibling).height
                              }px`)
                            : T(this.offsetBottom)
                            ...
                            : k(this.offsetBottom) &&
                              (t += ` - ${
                                  Pe(Tt(this.offsetBottom, this.$el)).height
                              }px`);
                    }
                    return (
                        (t += (e ? ` - ${e}px` : "") + ")"), { minHeight: t }
                    );
                },
                write({ minHeight: t }) {
                    Qt(
        ...
        jr = {
            ...
            connected() {
                this.svg = this.getSvg().then((t) => {
                    ...
                    return (
                        this.svgEl && e !== this.svgEl && be(this.svgEl),
                        Wr.call(this, e, t),
                        (this.svgEl = e)
                    );
                }, R);
    ...
    const qr = {
        ...
        Ur = {
            ...
            beforeConnect() {
                ...
                this.icon = this.$el.closest(".uc-nav-primary")
                    ? `${t}-large`
                    : t;
            },
        },
        Yr = {
            ...
            beforeConnect() {
                const t =
                    at(this.$el, "uc-search-toggle") ||
                    at(this.$el, "uc-navbar-toggle");
                if (
                    ((this.icon = t
                        ? "search-toggle-icon"
                        : at(this.$el, "uc-search-icon") &&
                          xt(this.$el, ".uc-search-large")
                        ? "search-large"
        ...
        Xr = {
            ...
            methods: {
                async getSvg() {
                    ...
                    return (
                        1 !== this.ratio &&
                            Qt(Te("circle", t), "strokeWidth", 1 / this.ratio),
                        t
                    );
                },
            },
        ...
        Jr = {
            ...
            beforeConnect() {
                ...
                Q(
                    t,
                    "role",
                    null !== this.role && de(t, "a") ? "button" : this.role
                );
        ...
        Gr = {
            ...
            beforeConnect() {
                ...
                const t = this.$props.icon;
                this.icon = at(this.$el, "uc-slidenav-large")
                    ? `${t}-large`
                    : t;
            },
        },
        ...
        Kr = {
            ...
            beforeConnect() {
                this.icon =
                    "close-" +
                    (at(this.$el, "uc-close-large") ? "large" : "icon");
            },
        },
    ...
    var oa = {
        ...
        connected() {
            "lazy" !== this.loading
                ? this.load()
                : ha(this.$el) && ((this.$el.loading = "lazy"), ra(this.$el));
        },
        disconnected() {
        ...
        methods: {
            load() {
                ...
                return (
                    et(t, "loading"), ra(this.$el, t.currentSrc), (this.img = t)
                );
            },
        },
    };
            ...
            }),
            {
                ...
                observe: (t, e) => {
                    const i = ui([...t, document.documentElement], e),
                        n = [
                            Lt(document, "scroll itemshown itemhidden", e, {
                                passive: !0,
                                capture: !0,
                            }),
                            Lt(
            ...
            read() {
                for (const t of this.target)
                    rt(
                        t,
                        "uc-light,uc-dark",
                        !this.selActive || bt(t, this.selActive) ? da(t) : ""
                    );
            },
        },
    };
    function da(t) {
        ...
        for (const r of [0.25, 0.5, 0.75]) {
            const a = t.ownerDocument.elementsFromPoint(
                Math.max(0, e) + s * r,
                Math.max(0, i) + n / 2
            );
            for (const e of a) {
                if (
                    t.contains(e) ||
                    (e.closest('[class*="-leave"]') &&
                        a.some((t) => e !== t && bt(t, '[class*="-enter"]')))
                )
                    continue;
    ...
    var ua = {
            ...
            update: {
                ...
                write({ width: t, fill: e, hide: i }) {
                    lt(this.wrapper, this.clsHide, i),
                        Q(this.wrapper, this.attrFill, new Array(t).join(e));
                },
                events: ["resize"],
            },
        },
        fa = {
            install: function ({ modal: t }) {
                function e(e, i, n = R, s = R) {
                    i = {
                        ...
                        escClose: !0,
                        ...i,
                        i18n: { ...t.i18n, ...(null == i ? void 0 : i.i18n) },
                    };
                ...
                (t.dialog = function (e, i) {
                    const n = t(
                        `<div class="uc-modal"> <div class="uc-modal-dialog">${e}</div> </div>`,
                        { stack: !0, role: "alertdialog", ...i }
                    );
                    return (
                        n.show(),
                        Lt(
                        ...
                        return e(
                            ({ i18n: e }) =>
                                `<div class="uc-modal-body">${
                                    k(t) ? t : fe(t)
                                }</div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-primary uc-modal-close" autofocus>${
                                    e.ok
                                }</button> </div>`,
                            i
                        );
                    ...
                    (t.confirm = function (t, i) {
                        return e(
                            ({ i18n: e }) =>
                                `<form> <div class="uc-modal-body">${
                                    k(t) ? t : fe(t)
                                }</div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-default uc-modal-close" type="button">${
                                    e.cancel
                                }</button> <button class="uc-button uc-button-primary" autofocus>${
                                    e.ok
                                }</button> </div> </form>`,
                            i,
                            () => Promise.reject()
                    ...
                    (t.prompt = function (t, i, n) {
                        const s = e(
                                ({ i18n: e }) =>
                                    `<form class="uc-form-stacked"> <div class="uc-modal-body"> <label>${
                                        k(t) ? t : fe(t)
                                    }</label> <input class="uc-input" value="${
                                        i || ""
                                    }" autofocus> </div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-default uc-modal-close" type="button">${
                                        e.cancel
                                    }</button> <button class="uc-button uc-button-primary">${
                                        e.ok
                                    }</button> </div> </form>`,
                                n,
                                () => null,
            ...
            data: {
                ...
                selClose:
                    ".uc-modal-close, .uc-modal-close-default, .uc-modal-close-outside, .uc-modal-close-full",
            },
            events: [
                {
    ...
    var pa = {
        extends: fr,
        data: { targets: "> .uc-parent", toggle: "> a", content: "> ul" },
    };
    ...
    var ga = {
        ...
        watch: {
            items() {
                const t = at(this.$el, "uc-navbar-justify"),
                    e = Ee(
                        ".uc-navbar-nav, .uc-navbar-left, .uc-navbar-right",
                        this.$el
                    );
                for (const i of e) {
                    Qt(
                        ...
                        t
                            ? Ee(
                                  ".uc-navbar-nav > li > a, .uc-navbar-item, .uc-navbar-toggle",
                                  i
                              ).length
                            : ""
                    );
        ...
        methods: {
            ...
            getDropbarOffset(t) {
                ...
                return (
                    e + ("behind" === this.dropbarTransparentMode ? 0 : i + t)
                );
            },
        },
    };
    var va = {
        ...
        events: [
            ...
            },
            {
                ...
                self: !0,
                handler() {
                    st(document.body, this.clsContainerAnimation),
                        Qt(document.body, "touch-action", "");
                },
            },
            {
                name: "hidden",
    ...
    function wa() {
        return (
            Te('meta[name="viewport"]', document.head) ||
            me(document.head, '<meta name="viewport">')
        );
    }
    var ba = {
            mixins: [en],
                    ...
                    return (
                        !!(this.content && this.container && ut(this.$el)) && {
                            max: Math.max(
                                this.minHeight,
                                Oe(this.container) -
                                    (Pe(this.content).height - Oe(this.$el))
                            ),
                        }
                    );
                },
        ...
        xa = {
            props: ["width", "height"],
            connected() {
                nt(this.$el, "uc-responsive-width"),
                    Qt(this.$el, "aspectRatio", `${this.width}/${this.height}`);
            },
        },
        $a = {
            props: { offset: Number },
    ...
    var Ia = {
            ...
            watch: {
                elements(t) {
                    this.hidden &&
                        Qt(wt(t, `:not(.${this.inViewClass})`), "opacity", 0);
                },
            },
            connected() {
        ...
        ka = {
            ...
            computed: {
                links: (t, e) =>
                    Ee('a[href*="#"]', e).filter((t) => t.hash && kt(t)),
                elements({ closest: t }) {
            ...
            watch: {
                links(t) {
                    this.scroll &&
                        this.$create("scroll", t, { offset: this.offset });
                },
            },
            observe: [mn(), bn()],
            update: [
                {
                    ...
                    write({ active: t }) {
                        ...
                        for (let e = 0; e < this.elements.length; e++)
                            lt(this.elements[e], this.cls, +e === t);
        ...
        Ca = {
            ...
            connected() {
                (this.start = Ea(this.start || this.top)),
                    ...
                    (this.placeholder =
                        Te("+ .uc-sticky-placeholder", this.$el) ||
                        Te('<div class="uc-sticky-placeholder"></div>')),
                    (this.isFixed = !1),
                    this.setActive(!1);
            },
            beforeDisconnect() {
                this.isFixed &&
                    (this.hide(), st(this.target, this.clsInactive)),
                    Aa(this.$el),
                    be(this.placeholder),
            ...
            observe: [
                wn({
                    handler() {
                        je("100vh", "height") !== this._data.viewport &&
                            this.$emit("resize");
                    },
                }),
            ...
            update: [
                {
                    read({ height: t, width: e, margin: i, sticky: n }) {
                        ...
                        "bottom" === l &&
                            (t < r || this.overflowFlip) &&
                            (c += r - t);
                        const d = this.overflowFlip
                                ? 0
                                : Math.max(0, t + c - o),
                            u = Me(h).top,
                            f = Me(this.$el).height,
                            p =
                                (!1 === this.start
                                    ? u
                                    : Ta(this.start, this.$el, u)) - c,
                            m =
                                !1 === this.end
                                    ? a
                                    : Math.min(
                                          a,
                                          Ta(this.end, this.$el, u + t, !0) -
                                              f -
                                              c +
                                              d
                                      );
                    ...
                    write({
                        ...
                        s &&
                            ((t = e = i = 0),
                            Qt(this.$el, { position: "sticky", top: n }));
                    ...
                    write(t, e) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (this.animation && c) {
                                    if (at(this.$el, "uc-animation-leave"))
                                        return;
                                    ce.out(this.$el, this.animation).then(
                                        () => this.hide(),
                                        R
                                    );
                                } else this.hide();
                                ...
                                this.isFixed
                                    ...
                                    : this.animation && c
                                    ? (this.show(),
                                      ce.in(this.$el, this.animation).catch(R))
                ...
                update() {
                    ...
                    if (!l) {
                        ...
                        e > o && ((r += o - a + n - i), (s = "absolute")),
                            Qt(
                                this.$el,
                                { position: s, width: t, marginTop: 0 },
                                "important"
                            );
                    }
                    Qt(this.$el, "top", r - n),
                    ...
                    (this.active = t),
                        t
                            ...
                            : (rt(
                              ...
                              e !== t &&
                                  (Da(this.target), Vt(this.$el, "inactive")));
                },
            },
        };
    function Ta(t, e, i, n) {
        if (!t) return 0;
        if (T(t) || (k(t) && t.match(/^-?\d/)))
            return i + je(t, "height", e, !0);
        {
            const i = !0 === t ? vt(e) : Tt(t, e);
            return (
                Me(i).bottom -
                (n && null != i && i.contains(e)
                    ? M(Qt(i, "paddingBottom"))
                    : 0)
            );
        }
    }
    ...
    function Da(t) {
        nt(t, "uc-transition-disable"),
            requestAnimationFrame(() => st(t, "uc-transition-disable"));
    }
    var Pa = {
        mixins: [jr],
        args: "src",
    ...
    const Ba = /<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,
        Oa = K(function (t) {
            const e = {};
            let i;
            for (Ba.lastIndex = 0; (i = Ba.exec(t)); )
                e[i[3]] = `<svg ${i[1]}svg>`;
            return e;
        });
    ...
    var za = {
            ...
            computed: {
                ...
                children(t, e) {
                    return St(e).filter((t) =>
                        this.toggles.some((e) => t.contains(e))
                    );
                },
            },
            watch: {
                connects(t) {
                    this.swiping && Qt(t, "touchAction", "pan-y pinch-zoom"),
                        this.$emit();
                },
                connectChildren() {
                    let t = Math.max(0, this.index());
                    for (const e of this.connects)
                        St(e).forEach((e, i) => lt(e, this.cls, i === t));
                    this.$emit();
                },
                toggles(t) {
                    this.$emit();
                ...
                },
                {
                    ...
                    el() {
                        return this.connects.concat(
                            this.itemNav ? Et(this.itemNav, this.$el) : []
                        );
                    },
                    delegate() {
                        return `[${this.attrItem}],[data-${this.attrItem}]`;
            ...
            update() {
                var t;
                Q(this.connects, "role", "presentation"),
                    Q(St(this.$el), "role", "presentation");
                for (const e in this.toggles) {
                    const i = this.toggles[e],
                        n =
                            null == (t = this.connects[0])
                                ? void 0
                                : t.children[e];
                    Q(i, "role", "tab"),
                        n &&
                ...
                Q(
                    this.$el,
                    "aria-orientation",
                    bt(this.$el, this.selVertical) ? "vertical" : null
                );
            },
            methods: {
                index() {
                ...
                show(t) {
                    ...
                    this.connects.forEach(async ({ children: t }) => {
                        const e = p(t).filter(
                            (t, e) => e !== s && at(t, this.cls)
                        );
                        await this.toggleElement(e, !1, o),
                            await this.toggleElement(t[s], !0, o);
                    });
                },
            },
        },
