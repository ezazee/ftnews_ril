...
//         $destinationDir = public_path('storage/gambar');
...
//             $this->info("🔄 Resize ke 664x374 → $destImagePath");
//             $resizeMain = $this->resizeImage($imagePath, $destImagePath, 664, 374);
