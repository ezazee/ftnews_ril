         ...
         <div class="card mb-3 table-configuration-wrap" style="display: none;">
            <div class="card-body">
               ...
               <div class="wrapper-filter">
                  ...
                  <form method="GET" action="{{ route('tags.index') }}" accept-charset="UTF-8" class="filter-form">
                             ...
                             <div class="col-auto">
                                 <div class="mb-3">
                                     <select class="form-select filter-column-key" name="filter_columns[]" required>
                                         ...
                                         <option value="nama_tags">Name</option>
                                         <option value="created_at">Created At</option>
                                     </select>
                                 </div>
                             </div>
                     ...
                     <div class="btn-list mt-3">
                         ...
                         <a class="btn btn-light" href="{{ route('tags.index') }}">Reset</a>
                     </div>
                 </form>
               </div>
            </div>
               ...
               <div class="w-100 justify-content-between d-flex flex-wrap align-items-center gap-1">
                  ...
                  <div class="d-flex align-items-center gap-1">
                     <button class="btn action-item btn-primary " tabindex="0"
                        ...
                        aria-expanded="false">
                        <span data-action="create" data-href="{{ route('tags.create') }}">
                     ...
                     <a class="btn" href="{{ route('tags.index') }}"><svg class="icon icon-left svg-icon-ti-ti-refresh" xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="card-table">
               <div class="table-responsive table-has-actions table-has-filter">
                  <table class="table card-table table-vcenter table-striped table-hover"
                     id="botble-blog-tables-tag-table">
                     <thead>
                        <tr>
                           ...
                           <th title="Created At" class=" column-key-2">
                              Created At
                           </th>
