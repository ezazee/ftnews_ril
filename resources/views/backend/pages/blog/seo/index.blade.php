                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">SEO Post List</h1>
                                </li>
                            </ol>
                        </nav>
                ...
                <div class="card mb-3 table-configuration-wrap" style="display: none;">
                    <div class="card-body">
                        ...
                        <div class="wrapper-filter">
                            ...
                            <form method="GET" action="{{ route('blog.seoPost') }}" accept-charset="UTF-8" class="filter-form">
                                ...
                                <div class="btn-list mt-3">
                                    ...
                                    <a class="btn btn-light" href="{{ route('blog.seoPost') }}">Reset</a>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <table class="table card-table table-vcenter table-striped table-hover"
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="text-start  column-key-6 text-center  column-key-6  column-key-6">{{ $item->view }}</td>
                                        <td class="text-start  column-key-6 text-center  column-key-6  column-key-6">
