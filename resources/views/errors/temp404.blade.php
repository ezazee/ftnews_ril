...
@section('content')
    <div id="wrapper" class="wrap overflow-hidden-x">
        {{-- Error Section --}}
        <section class="error-section text-center py-5">
            <div class="container max-w-lg">
                <div class="error-container">
                    <div class="h1">404</div>
                    <div class="h6">Maaf kami tidak menemukan halaman yang Anda cari.</div>
                    <div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 500 500">
                            <g id="freepik--background-complete--inject-14">
                                ...
                                <rect x="74.93" y="76.84" width="1.37" height="10.1"
                                    transform="translate(24.11 180.74) rotate(-109.76)" style="fill:#f0f0f0"></rect>
                            </g>
                            <g id="freepik--Shadow--inject-14">
                                <ellipse id="freepik--path--inject-14" cx="250" cy="416.24" rx="193.89"
                                    ry="11.32" style="fill:#f5f5f5"></ellipse>
                            </g>
                            <g id="freepik--oops--inject-14">
                                <path
                            ...
                            <g id="freepik--error-404--inject-14">
                                ...
                                <path
                                    ...
                                    style="fill:#4EA5DD;opacity:0.30000000000000004"></path>
                                <path
                                ...
                                <path
                                    ...
                                    style="fill:#263238"></path>
                                <path d="M414.83,153.37a.82.82,0,0,1-1.64-.06.82.82,0,0,1,1.64.06Z" style="fill:#263238">
                                </path>
                                ...
                                <path d="M401.5,222.57a.81.81,0,0,1-.85.79.82.82,0,1,1,.85-.79Z" style="fill:#263238">
                                </path>
                            ...
                            <g id="freepik--robot-parts--inject-14">
                                ...
                                <rect x="339.07" y="411.71" width="1.37" height="10.1"
                                    transform="translate(469.33 938.61) rotate(-154.76)" style="fill:#263238"></rect>
                            </g>
                        </svg>
                    </div>
                    <div>
                ...
                <div class="post-related panel text-start pt-2 xl:mt-5">
                    <h4 class="h5 xl:h4">Kumpulan Berita yang Mungkin Anda Suka</h4>
                                    ...
                                    <figure
                                        ...
                                        @if (!empty($terkini->gambar) && is_array($terkini->gambar))
                                            ...
                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                src="{{ asset('storage/' . $firstImage) }}" alt="{{ $terkini->title }}"
                                                data-uc-img="loading: lazy">
                                        @endif
                                        <a href="{{ route('bytitle', ['slug' => $terkini->slug]) }}"
                                            class="position-cover" data-caption="{{ $terkini->title }}"></a>
                                    </figure>
                                    <div class="post-header panel vstack gap-1">
                                        <h5 class="h6 md:h5 m-0">
                                            <a class="text-none"
                                                href="{{ route('bytitle', ['slug' => $terkini->slug]) }}">{{ $terkini->title }}</a>
                                        </h5>
