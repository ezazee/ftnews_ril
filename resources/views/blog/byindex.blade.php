                            ...
                            <div class="card__post card__post-list card__post__transition mb-4">
                                <article class="post type-post panel uc-transition-toggle">
                                    <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                        ...
                                        <div class="col">
                                            <div
                                                class="post-meta panel hstack justify-start gap-1 mb-1 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                <div>
                                            ...
                                            <div
                                                class="post-meta panel hstack justify-start gap-1 mt-2 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                <div class="d-none md:d-block">
                                                    <div class="post-date hstack gap-narrow">
                                                        <span>{{ \Carbon\Carbon::parse($item->created_at)->isoFormat('DD MMMM, YYYY') }}</span>
                                                        <div class="sep d-none md:d-block">❘</div>
                                                        <span>{{ \Carbon\Carbon::parse($item->created_at)->format('H:i:s') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="ad-inside-feed my-4">
                                @if ($index % 6 == 0)
                                    ...
                                    <ins class="adsbygoogle"
                                         ...
                                         data-ad-layout-key="-ih+g-4-6x+d4"
                                         data-ad-client="ca-pub-7366174212541814"
                                         data-ad-slot="9004629226"></ins>
                                    <script>
