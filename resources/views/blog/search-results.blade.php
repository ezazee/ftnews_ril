                    ...
                    <div class="card__post card__post-list card__post__transition mb-4">
                        <article class="post type-post panel uc-transition-toggle">
                            <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                ...
                                <div class="col">
                                    <div class="post-meta panel hstack justify-start gap-1 mb-2 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                        <div>
                                    ...
                                    <p class="post-excerpt ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">
                            ...
                            <div class="ad-inside-feed my-4">
                                @if ($index % 6 == 0)
                                    ...
                                    <ins class="adsbygoogle"
                                         ...
                                         data-ad-layout-key="-i2+g-4-6x+d4"
                                         data-ad-client="ca-pub-7366174212541814"
                                         data-ad-slot="7579866916"></ins>
                                    <script>
