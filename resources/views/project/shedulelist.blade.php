@extends('layouts.vertical', ['title' => 'List Shedule Post', 'sub_title' => 'List Shedule Post', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
@include('sweetalert::alert')

<form action="{{ route('post.shedule') }}" method="GET" class="flex items-center p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
    <input
        type="text"
        name="search"
        id="searchInput"
  ...
  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
              ...
              <th scope="col" class="px-6 py-3">Shedule Date Time</th>
