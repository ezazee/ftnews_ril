@extends('layouts.vertical', ['title' => 'List Private Post', 'sub_title' => 'List Private Post', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
@include('sweetalert::alert')

<form action="{{ route('post.private') }}" method="GET" class="flex items-center p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
    <input
        type="text"
        name="search"
        id="searchInput"
