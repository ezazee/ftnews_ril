<header class="wrap-header">
    <div class="main-header">
        ...
        <div class="header-logo--wrap">
            <a href="/">
                <img src="{{ asset('frontend/logo/logo.png') }}" width="155" height="24" alt="FTNews" class="logo">
            </a>
        </div>
        ...
        <footer>
            <div class="footer-social-media">
                <div class="social-media-wrap">
                    <a class="social-media-item" href="https://web.facebook.com/ftnewscoid" target="_blank">
                    ...
                    <a class="social-media-item" href="https://www.tiktok.com/@ftnews.co.id" target="_blank">
                        <svg fill="currentColor" width="32" height="32" viewBox="0 0 512 512" id="icons"
                    ...
                    <a class="social-media-item" href="https://www.youtube.com/@FTNewscoid" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                    ...
                    <a class="social-media-item" href="https://www.instagram.com/ftnews.co.id/" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                    ...
                    <a class="social-media-item" href="https://whatsapp.com/channel/0029Vb7g7dnFMqrgveDpgg0O"
                        target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                            viewBox="0 0 16 16">
                            <path
                                d="M13.601 2.326A7.956 7.956 0 0 0 8.002 0C3.584 0 0 3.584 0 8c0 1.409.368 2.789 1.066 4.004L.057 15.25a.5.5 0 0 0 .684.606l3.294-1.316A7.96 7.96 0 0 0 8.002 16c4.418 0 8.002-3.584 8.002-8 0-2.133-.833-4.138-2.403-5.674zm-5.6 12.57a6.963 6.963 0 0 1-3.522-.95.5.5 0 0 0-.435-.034l-2.392.956.626-2.462a.5.5 0 0 0-.05-.37A6.963 6.963 0 0 1 1 8c0-3.866 3.134-7 7.002-7 1.87 0 3.627.728 4.95 2.049A6.963 6.963 0 0 1 15 8c0 3.866-3.134 7-7.002 7zm3.225-5.406c-.197-.099-1.17-.578-1.352-.644-.181-.066-.314-.099-.447.099-.132.198-.513.644-.629.777-.116.132-.232.148-.429.05-.197-.099-.832-.307-1.586-.98-.587-.522-.983-1.168-1.099-1.365-.116-.198-.013-.305.086-.403.089-.089.198-.232.297-.347.099-.116.132-.198.198-.33.066-.132.033-.248-.017-.347-.05-.099-.447-1.08-.612-1.48-.161-.388-.325-.335-.447-.341-.116-.006-.248-.007-.38-.007a.73.73 0 0 0-.53.248c-.182.198-.693.677-.693 1.654 0 .977.71 1.922.81 2.057.099.132 1.397 2.137 3.393 2.914.475.164.844.262 1.133.335.476.114.91.098 1.253.06.382-.045 1.17-.478 1.336-.94.165-.462.165-.857.116-.94-.05-.083-.181-.132-.38-.231z" />
                        </svg>
                    </a>
                </div>
                <p class="footer-social-media-desc">Dapatkan informasi terkini dan terbaru yang dikirimkan langsung ke
                    Inbox anda</p>
            </div>
