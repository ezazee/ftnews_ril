        ...
        <div class="content-article">
            ...
            <div class="mt-20">
                ...
                @if ($topPostNasional)
                    ...
                    @endphp
                    <article class="card-one-headline">
                        <img alt="{{ $topPostNasional->title }}" class="card-one-headline-img" width="310"
                            height="230"
                            src="{{ isset($images[0]) ? asset('storage/comp/' . basename($images[0])) : '' }}" />
                        <div class="card-one-headline--info">
                            <h2 class="card-one-headline--title">
                            ...
                            <div class="category-and-time">
                                <div class="card-one-headline--desc">{!! Str::limit(strip_tags($topPostNasional->content), 150) !!}</div>
            ...
            <div class="mt-20">
                ...
                @if ($topPostDaerah)
                    ...
                    <article class="card-kanal-headline">
                        <img alt="{{ $topPostDaerah->title }}" class="card-kanal-headline-img" width="310"
                            height="230"
                            src="{{ isset($images[0]) ? asset('storage/comp/' . basename($images[0])) : '' }}" />
                        <div class="card-kanal-headline--info">
                            ...
                            <div class="category-and-time">
                                <div class="card-one-headline--desc">{!! Str::limit(strip_tags($topPostDaerah->content), 150) !!}</div>
            ...
            <div class="mt-20">
                ...
                @if ($topPostLifestyle)
                    ...
                    @endphp
                    <article class="card-one-headline">
                        <img alt="{{ $topPostLifestyle->title }}" class="card-one-headline-img" width="310"
                            height="230"
                            src="{{ isset($images[0]) ? asset('storage/comp/' . basename($images[0])) : '' }}" />
                        <div class="card-one-headline--info">
                            <h2 class="card-one-headline--title">
                            ...
                            <div class="category-and-time">
                                <div class="card-one-headline--desc">{!! Str::limit(strip_tags($topPostLifestyle->content), 150) !!}</div>
                ...
                <div class="card-two-wrap">
                    @foreach ($otherPostsLifestyle as $post)
                        <article class="card-two-headline">
                            <div class="card-two-headline-img-wrap">
                                <img alt="{{ $post->title }}" class="card-two-headline-img" width="100"
                                    height="74"
                                    src="{{ asset('storage/comp/' . (is_array($post->gambar) ? basename($post->gambar[0]) : basename($post->gambar))) }}" />
                            </div>
                            <div class="card-two-headline--info">
            ...
            <div class="mt-20">
                ...
                @if ($topPostTeknologi)
                    ...
                    @endphp
                    <article class="card-kanal-headline">
                        <img alt="{{ $topPostTeknologi->title }}" class="card-kanal-headline-img" width="310"
                            height="230"
                            src="{{ isset($images[0]) ? asset('storage/comp/' . basename($images[0])) : '' }}" />
                        <div class="card-kanal-headline--info">
                            <h2 class="card-kanal-headline--title">
                            ...
                            <div class="category-and-time">
                                <div class="card-one-headline--desc">{!! Str::limit(strip_tags($topPostTeknologi->content), 150) !!}</div>
            ...
            <div class="mt-20">
                ...
                @if ($topPostOlahraga)
                    ...
                    @endphp
                    <article class="card-one-headline">
                        <img alt="{{ $topPostOlahraga->title }}" class="card-one-headline-img" width="310"
                            height="230"
                            src="{{ isset($images[0]) ? asset('storage/comp/' . basename($images[0])) : '' }}" />
                        <div class="card-one-headline--info">
                            <h2 class="card-one-headline--title">
                            ...
                            <div class="category-and-time">
                                <div class="card-one-headline--desc">{!! Str::limit(strip_tags($topPostOlahraga->content), 150) !!}</div>
            ...
            <div class="mt-20">
                ...
                @if ($topPostOtomotif)
                    ...
                    @endphp
                    <article class="card-kanal-headline">
                        <img alt="{{ $topPostOtomotif->title }}" class="card-kanal-headline-img" width="310"
                            height="230"
                            src="{{ isset($images[0]) ? asset('storage/comp/' . basename($images[0])) : '' }}" />
                        <div class="card-kanal-headline--info">
                            <h2 class="card-kanal-headline--title">
                            ...
                            <div class="category-and-time">
                                <div class="card-one-headline--desc">{!! Str::limit(strip_tags($topPostOtomotif->content), 150) !!}</div>
